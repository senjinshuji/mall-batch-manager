...
export default function ViewRecordsPage() {
  ...
  const fetchPlatformData = async (
    ...
    // アカウント×日付でスナップショットを集約（累計値）
    // キー: accountId, 値: { "YYYY-MM-DD": 累計再生数 }
  ...
  return (
    <div className="max-w-full">
      <h1 className="text-2xl font-bold mb-4">再生数記録</h1>
